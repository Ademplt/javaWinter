...
public class C02_IstenenElementleriListele {
 ...
 Sonuc è [Ali, Veli]
    ...
    public static void main(String[] args) {
       ...
       List<String> isteneDiliBilenlerListesi=istenenDiliBilenListesiOlustur(sinifMap,istenenDil);
    }

    public static List<String> istenenDiliBilenListesiOlustur(Map<Integer, String> sinifMap, String istenenDil) {
        List<String> isteneDiliBilenlerListesi=new ArrayList<>();
       // isteneDiliBilenlerListesi.addAll(sinifMap.values());
        return null;
    }
}
